...
const ES_URL = localStorage.getItem("backend");
...
function updateBackend() {
    let backend = document.getElementById("backend-server").value;
    localStorage.setItem("backend", backend);
    window.location.reload();
}

function updateAPM() {
    let apm = document.getElementById("apm-server").value;
    localStorage.setItem("apm", apm);
    window.location.reload();
}


function loadBackendSettingUI() {
    document.getElementById("backend-server").value = localStorage.getItem("backend");
}

function loadAPMSettingUI() {
    document.getElementById("apm-server").value = localStorage.getItem("apm");
}
...
function evalResultMode() {
    if (resultMode) {
        ...
        document.getElementById("backend-settings").classList.add("result-mode");
    } else {
        ...
        document.getElementById("backend-settings").classList.remove("result-mode");
    }
}
...
loadBackendSettingUI();
loadAPMSettingUI();

if (ES_URL == null) {
    document.getElementById("recipe-banner").classList.add("result-mode");
    document.getElementById("recipe-search-box").classList.add("result-mode");
}